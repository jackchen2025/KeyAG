...
% 主程序文件
%-------------------------------------------------------------------------------------------
%% Copyright (c) 2020 by Jiabao Chen
%% -------------------------------------------------------------------------------------------
...
又其中心不存在，知为(\uppercase\expandafter{\romannumeral2})类方程$\displaystyle\frac{1}{2}x^2-\displaystyle\frac{1}{2}y^2+d=0$的形式，不论$d$或正或负，都有方程为双曲抛物面. 
...
代入(\uppercase\expandafter{\romannumeral1})类方程，得$$-2x^2+y^2-z^2+\displaystyle\frac{1}{2}=0$$
其余类型方程不存在.
\end{enumerate}
